...
#     print(data.astype('int'))
    ...
    gps_decoded = dict()
    gps_decoded['time'] = d
    gps_decoded['weeknum_pos'] = weeknums_pos
    gps_decoded['sec_offset_pos'] = sec_offset_pos
    gps_decoded['weeknum_vel'] = weeknums_vel
    gps_decoded['sec_offset_vel'] = sec_offset_vel
